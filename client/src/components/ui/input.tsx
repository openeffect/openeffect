  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      <input
        ...
        type={type}
        className={cn(
          'w-full rounded-lg border bg-muted px-3 py-2 text-sm text-foreground outline-none placeholder:opacity-40 hover:border-foreground/15 focus-visible:border-ring',
          className,
        )}
        {...props}
      />
